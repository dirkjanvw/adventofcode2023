...
public class Sky {
     ...
     * @param expansion the number of times to expand the empty sky
     */
    public void expand(int expansion) {
        ...
        for (Galaxy galaxy : this.galaxies) {
            ...
            galaxy.setX(galaxy.getX() + emptyColumnsToLeft * (expansion - 1));
        }
        ...
        for (Galaxy galaxy : this.galaxies) {
            ...
            galaxy.setY(galaxy.getY() + emptyRowsAbove * (expansion - 1));
        }
    }
